            ...
            <div class="dropdown-menu dropdown-menu-right notification-dropdown rtl-ps-none"
                ...
                <div class="dropdown-item d-flex">
                    ...
                    <div class="notification-details flex-grow-1">
                        ...
                        <p class="text-small text-muted m-0">QAE-2 Released</p>
                    </div>
                </div>
                <div class="dropdown-item d-flex">
                    <div class="notification-icon">
                    ...
                    <div class="notification-details flex-grow-1">
                        ...
                        <p class="text-small text-muted m-0">New Genesis Token : ROCK</p>
                    </div>
                </div>
                <div class="dropdown-item d-flex">
                    <div class="notification-icon">
                    ...
                    <div class="notification-details flex-grow-1">
                        ...
                        <p class="text-small text-muted m-0">Explorer Maintenance</p>
                    </div>
                </div>
                <div class="dropdown-item d-flex">
                    <div class="notification-icon">
